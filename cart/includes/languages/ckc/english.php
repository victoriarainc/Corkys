...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . 'Corky&#39;s Kettle Corn LLC' . '</a> - Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>');
...
// information box text in sideboxes/information.php
  define('BOX_HEADING_INFORMATION', 'Customer Service');
...
// information box text in sideboxes/more_information.php - were TUTORIAL_
  define('BOX_HEADING_MORE_INFORMATION', 'Information');
  define('BOX_INFORMATION_PAGE_2', 'Events and Retail');
  define('BOX_INFORMATION_PAGE_3', 'About Us');
  define('BOX_INFORMATION_PAGE_4', 'Fundraising');
